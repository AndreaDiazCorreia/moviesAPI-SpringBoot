...
This is a simple API for a project to display a list of movies, review data and add additional reviews.

The API was developed using Spring Boot and MongoDB.

## Endpoints

### Get all movies

With this endpoint you get a list of all the movies in the database.
...
[
    {
        "id": {
            "timestamp": 1684341245,
            "date": "2023-05-17T16:34:05.000+00:00"
        },
        "imdbId": "tt3915174",
...
Adding the imdbId of a movie to the end of the endpoint you can get a single movie :
...
```json
{
  ...
  "reviews": [
    {
      "id": {
        "timestamp": 1684528897,
        "date": "2023-05-19T20:41:37.000+00:00"
      },
      "body": "A really good movie",
      "created": "2023-05-19T17:41:37.312",
      "updated": "2023-05-19T17:41:37.312"
    }
  ]
}
```
...
With this endpoint you can add a review to a movie, you need to send a json with the body and the imdb id and if it is in the list the review will be added.
...
```json
{
  "reviewBody": "a really good movie",
  "imdbId": "tt1234567"
}
```
...
| --- | --- | --- |
| reviewBody | string | The review description |
| imdbId | string | IMDb ID of the movie |
...
```json
{
    ...
    "body": "a really good movie",
    "created": "2023-05-19T17:41:37.3120231",
    "updated": "2023-05-19T17:41:37.3120231"
}
```
This is a very simple API just to exercise connecting an API to the frontend, maybe in the future I will add more options.
